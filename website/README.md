...
- `src/main.jsx`: biography, article links, current work, and contacts.
...
[React Bits Threads](https://reactbits.dev/backgrounds/threads) by David Haz. Its upstream source is included as part of this website with the [MIT + Commons Clause license](src/components/REACT-BITS-LICENSE.md). Geometric article artwork and static orbital fallback are original CSS.
